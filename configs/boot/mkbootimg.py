...
def write_header(args):
    ...
    final_second_offset = (args.base + args.second_offset) if filesize(args.ramdisk) > 0 else 0
...
def parse_cmdline():
    ...
    #parser.add_argument('--second', help='path to second bootloader', type=FileType('rb'))
    ...
    parser.add_argument('--second_offset', help='second offset', type=parse_int, default=0x00f00000)
...
def write_data(args, pagesize):
    ...
    write_padded_file(args.output, args.ramdisk, pagesize) # write ramdisk twice for the BS bbry bootloader
